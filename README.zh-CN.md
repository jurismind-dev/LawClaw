...
**小龙芯 (LawClaw)** 是一款面向律师和法律专业人士的 AI 助手桌面应用，由法义经纬 (Jurismind) 进行法律领域定制开发。

LawClaw 基于官方 [OpenClaw](https://github.com/OpenClaw) 运行时，提供易用、美观的桌面化 AI 编排体验。小龙芯在此强大基础上，针对法律行业进行深度定制，提供智能法律研究、文档分析、案件摘要和合同审查等专业功能。
