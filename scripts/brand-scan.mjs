...
const ALLOWLIST = [
  { path: /^README\.en\.md$/, line: /ValueCell-ai\/ClawX/ },
  { path: /^README\.en\.md$/, line: /Based on.*ClawX/ },
  { path: /^README\.en\.md$/, line: /The upstream project this is based on.*ClawX/ },
  { path: /^README\.en\.md$/, line: /<a href="https:\/\/github\.com\/ValueCell-ai\/ClawX">ClawX<\/a>/ },
  { path: /^README\.en\.md$/, line: /^cd ClawX$/ },
  { path: /^README\.md$/, line: /ValueCell-ai\/ClawX/ },
  { path: /^README\.md$/, line: /基于项目.*ClawX/ },
  { path: /^README\.md$/, line: /上游基础.*ClawX/ },
