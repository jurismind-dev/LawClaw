...
export const PROVIDER_TYPE_INFO: ProviderTypeInfo[] = [
  { id: 'jurismind', name: 'Jurismind\uff08\u6cd5\u4e49\u7ecf\u7eac\uff09', icon: '\u2696\ufe0f', placeholder: 'token_key will be auto-filled after SSO login', model: 'Kimi', requiresApiKey: true, defaultBaseUrl: 'http://101.132.245.215:3001/v1', defaultModelId: 'kimi-k2.5' },
