      ...
      >
        <div className="min-w-0 flex-1">
          ...
          {step.detail && !expanded && (
            <p className="mt-1 line-clamp-2 text-[12px] leading-5 text-muted-foreground">{step.detail}</p>
          )}
        </div>
        {hasDetail && (
...
export function ExecutionGraphCard({
  ...
  return (
    <div
      ...
      className="w-full rounded-2xl bg-muted px-4 py-4"
    >
            ...
            {index === steps.length - 1 && (
              <>
                ...
                <button
                  ...
                  className="flex items-center gap-2 pl-11 text-[12px] text-muted-foreground transition-colors hover:text-foreground"
                >
