...
describe('openclaw auth - clear agent model', () => {
  it('clearOpenClawAgentModelPrimary only removes model.primary for the target agent', async () => {
    ...
    mod.clearOpenClawAgentModelPrimary('lawclaw-main');
    ...
    expect(lawclawMain?.model?.primary).toBeUndefined();
